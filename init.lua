...
local stone_with_silver = nil
local stone_with_mithril = nil
local rack_with_silver = nil
local rack_with_mithril = nil

if minetest.get_modpath("moreores") then
	minetest.register_node( "nether:rack_with_silver", {
		description = "Silver Ore",
		tiles = { "nether_rack.png^moreores_mineral_silver.png" },
		is_ground_content = true,
		groups = {cracky=3},
		drop = "moreores:silver_lump 2",
		sounds = default.node_sound_stone_defaults(),
	}) 
	minetest.register_node( "nether:rack_with_mithril", {
		description = "Mithril Ore",
		tiles = { "nether_rack.png^moreores_mineral_mithril.png" },
		is_ground_content = true,
		groups = {cracky=3},
	...
	stone_with_silver = minetest.get_content_id("moreores:mineral_silver")
	stone_with_mithril = minetest.get_content_id("moreores:mineral_mithril")
	rack_with_silver = minetest.get_content_id("nether:rack_with_silver")
	rack_with_mithril = minetest.get_content_id("nether:rack_with_mithril")
end

local stone_with_chromium = nil
local rack_with_chromium = nil

if minetest.get_modpath("technic") then
	minetest.register_node( "nether:rack_with_chromium", {
		description = "Chromium Ore",
		tiles = { "nether_rack.png^technic_mineral_chromium.png" },
		is_ground_content = true,
		groups = {cracky=3},
		drop = "technic:chromium_lump 2",
		sounds = default.node_sound_stone_defaults(),
	}) 

	stone_with_chromium = minetest.get_content_id("technic:mineral_chromium")
	rack_with_chromium = minetest.get_content_id("nether:rack_with_chromium")
end
	...
	for z = z0, z1 do -- for each xy plane progressing northwards
		for y = y0, y1 do -- for each x row progressing upwards
			...
			for x = x0, x1 do -- for each node do
				...
				elseif d == stone_with_silver then
					data[vi] = rack_with_silver
				elseif d == stone_with_mithril then
					data[vi] = rack_with_mithril
				elseif d == stone_with_chromium then
					data[vi] = rack_with_chromium
